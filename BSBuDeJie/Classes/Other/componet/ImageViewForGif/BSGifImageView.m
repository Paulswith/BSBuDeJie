...
@interface BSGifImageView ()

@property (nonatomic, strong) BSGIFImage *animatedImage;
...
- (void)setImage:(UIImage *)image
{
    ...
    if ([image isKindOfClass:[BSGIFImage class]] && image.images) {
        if([image.images[0] isKindOfClass:UIImage.class])
            [super setImage:image.images[0]];
        else
            [super setImage:nil];
        self.currentFrame = nil;
        self.animatedImage = (BSGIFImage *)image;
...
- (void)setAnimatedImage:(BSGIFImage *)animatedImage
{
